  ...
  return (
    <Box w='100%' h='100vh' bg='url(images/bg.jpg)' bgPos='center' bgSize={'cover'} id='home'>
        <Flex flexDir={'column'} bg='rgba(0,0,0,0.6)' w='100%' h='100%'>
            <Header/>
            <Flex w='100%' align='center' flexDir='column' justify='center' h='70%' maxW='800px' m='auto' gap='20px' p={'0 7px'} textAlign='center'>
              <Reveal>
              ...
              <Reveal>
                <Button color='white' variant='outline' p='20px' rightIcon={<FaArrowRight/>} h='50px' borderRadius='20px' _hover={{bg:'black'}}>Download my CV</Button>
              </Reveal>
            </Flex>
        </Flex>
    </Box>
